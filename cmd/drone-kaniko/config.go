...
func settingsFlags() []cli.Flag {
	...
	return []cli.Flag{
		...
		&cli.BoolFlag{
			Name:    "include-platform-tags",
			Usage:   `Include platform tags in the manifest`,
			EnvVars: []string{"PLUGIN_INCLUDE_PLATFORM_TAGS"},
		},
		&cli.StringSliceFlag{
...
func settingsFromContext(ctx *cli.Context) kaniko.Settings {
	return kaniko.Settings{
		...
		Main: kaniko.Main{
			...
			IncludePlatformTags: ctx.Bool("include-platform-tags"),
		},
